...
In _The Diamond Age,_ the Primer is not the environment Nell ultimately uses to lead her troops, and it’s not the environment she’ll use to generate novel ideas for society (its authors’ ultimate goal). It’s best understood as an _onboarding_ experience for the rest of her life. It conveys its payload via the mechanism described in [[The Primer is an enormous enacted experience]], then it’s meant to be transcended and left behind.
