...
Q. How does SRS prompt connectivity relate to pattern matching? A. Low-connectivity prompts (especially “orphans”) are more likely to be pattern matched.

Q. How might application prompts help with SRS pattern matching? A. They make you use your knowledge in new contexts.

Q. How does SRS prompt length relate to pattern matching? A. Shorter prompts seem harder to pattern match.
