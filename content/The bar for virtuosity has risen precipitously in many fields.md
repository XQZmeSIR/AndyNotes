...
Q. Give an example of a way in which the bar for virtuosity has risen precipitously, not attributable to new tools. (Give an example you haven’t given recently) A. [Marathon runners, musician performances, double somersaults, digits of pi]()
