...
1. Write durable notes continuously while reading and thinking. ([[Evergreen note-writing as fundamental unit of knowledge work]]) 2. Each time you add a note, add a link to it to an outline, creating one if necessary ([[Create speculative outlines while you write]]). 3. Eventually, you’ll feel excited about fleshing out one of those outlines. ([[Let ideas and beliefs emerge organically]]) 4. Write new notes to fill in missing pieces of the outline. 5. Concatenate all the note texts together to get an initial manuscript 6. Rewrite it.

## Directed version:

1. Review notes related to your topic (and a step or two beyond those—[[Notes should surprise you]]) 2. Write an outline 3. Attach existing notes to each point in the outline; write new notes as needed. 4. Concatenate all the note texts together to get an initial manuscript 5. Rewrite it.
