...
Cleaning the kitchen isn’t like that. Even clearing out one’s inbox isn’t like that ([[Triage strategies for maintaining inboxes (e.g. Inbox Zero) are often too brittle]]). For many prosaic goals, you have
**executable strategies** , which reliably achieve the goal with a predictable, manageable amount of effort. They’re a kind of metacognitive support ([[Metacognitive supports as cognitive scaffolding]]).
