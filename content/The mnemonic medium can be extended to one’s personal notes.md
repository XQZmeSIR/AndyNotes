...
And one might create a traditional two-sided prompt like this: Q. If one only took notes in Anki, what key limitations might one experience? A. (e.g. no serendipitous note-finding when note-writing, no way to easily evolve notes over time, limited connections between notes, difficult to “read through” one’s notes on a subject, etc)
...
There are a few other implementations of something like this idea:
  ...
  * Importers into external SRS
    ...
    * [[Obisidan _to_ Anki]]. Requires some manual steps.
    * [[Ankify]], which requires manual steps—not meant to run automatically in the background.
  * Uses integrated SRS
    * [[RemNote]], an increasingly polished webapp implementation
    * [[Mochi]], whose interactions de-emphasize writing prose notes
    * [[org-fc]], a polished implementation for org-mode
    * [[TiddlyRemember]], syncs with TiddlyWiki using some custom markup; requires a manual sync step, by [[Soren Bjornstad]]
    * [[Fishing — v2.0.2]] another TiddlyWiki-based implementation
