...
1. gets trashed (doesn’t look like it’s worth a detailed read after all) 2. gets read in a serious fashion (i.e. [[Write about what you read to internalize texts deeply]]) 3. gets read shallowly and filed in the reference library 4. (maybe) gets added to some other list like “recipes to be cooked”
...
1. zero-friction capture for books, articles, web pages (to easily close that loop) 2. zero-friction to view the reading corresponding to an inbox item 3. zero-friction listing across item type 4. the inbox should encourage lingering items to be removed (e.g. it should be obvious when one has been passed over many times)
