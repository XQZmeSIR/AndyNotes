...
> It’s unlikely you write notes today as you did 6 years ago. You use > different terms. > > Every full text search presents tons of Zettel notes. Because all are > seemingly equal (and connected in the same way: not at all), you have to > either rely on your memory to distinguish useful from useless notes, or look > through all of them every time.
