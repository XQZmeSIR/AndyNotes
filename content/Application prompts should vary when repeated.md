...
Q. What happens if the question asked by an application prompt in the mnemonic medium doesn’t vary from session to session? A. The application prompt turns into a recall prompt.
