...
The best routes currently seem to be (updated [[2022-07-05]]):
  ...
  * [[Visual speech recognition]] (i.e. from video of the lips or face). Only cheap, widely-available equipment needed (some systems use RGB-D cameras).
    ...
    * K R Prajwal, Triantafyllos Afouras, Andrew Zisserman. Sub-word Level Lip Reading With Visual Attention. 2021.
      * word error rate of 22.6% on LRS2 (television clips)
  * Sub-audible acoustic recognition
    ...
    * Whispering:
    * Hiraki, H., & Rekimoto, J. (2022). SilentWhisper: Faint whisper speech using wearable microphone. The Adjunct Publication of the 35th Annual ACM Symposium on User Interface Software and Technology, 1–3. <https://doi.org/10.1145/3526114.3558715>
...
Apart from the specific systems above, this book offers a helpful survey: [[Freitas, J., Teixeira, A., Dias, M. S., & Silva, S. (2017). An Introduction to Silent Speech Interfaces. Springer International Publishing]]
