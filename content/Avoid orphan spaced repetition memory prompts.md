...
1. After a while, these isolated prompts often start to feel like a burden in the review session, disconnected from what you actually care about (contra [[The critical thing to optimize in spaced repetition memory systems is emotional connection to the review session and its contents]]) 2. You’ll likely have more trouble remembering the answers to these questions, since they won’t be naturally reinforced through your daily life. Even if you do remember the answers, there’s a danger that they’ll be pattern-matched because they don’t connect to other knowledge ([[Spaced repetition memory prompts should be written to discourage shallow “pattern matching”]])
